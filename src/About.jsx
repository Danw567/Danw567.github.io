...
function CourseBadges() {
    return(
        <aside className='about-badges-cont'>
            <img src="images/code_for_data.png" alt="Badge for 'Learn to code for data analysis'" />
            <img src="images/Intro_Cybersec_badge.png" alt="Badge for 'Introduction to cyber security stay safe online'" />
            <img src="images/Discovering_comp_networks_badge.png" alt="Badge for 'Discovering computer networks'" />
        </aside>
    )
}
...
function MyTechStack() {
    ...
    const techStack = [
        {tech: "HTML", key: 0, image: ""},
        {tech: "CSS", key: 1, image: ""},
        {tech: "JavaScript", key: 2, image: ""},
        {tech: "JQuery", key: 3, image: ""},
        {tech: "C#", key: 4, image: ""},
